...
Settings.gitlab['restricted_visibility_levels_snippets'] = Settings.send(:verify_constant_array, Gitlab::VisibilityLevel, Settings.gitlab['restricted_visibility_levels_snippets'], [])
